...
//     /**
//      * 테스트용 - 매 10분마다 실행 (개발 환경용)
//      * 프로덕션에서는 비활성화됨
//      */
//     @Scheduled(cron = "0 */10 * * * *", zone = "Asia/Seoul")
//     @ConditionalOnProperty(name = "crawler.scheduling.test-enabled", havingValue = "true", matchIfMissing = false)
//     public void testScheduledCrawling() {
//         log.info("테스트 스케줄된 크롤링 시작 - {}", java.time.LocalDateTime.now());
        
//         try {
//             deploymentOptimizedCrawlerService.runDeploymentOptimizedCrawling();
//             log.info("테스트 스케줄된 크롤링 완료");
            
//         } catch (Exception e) {
//             log.error("테스트 스케줄된 크롤링 실패: {}", e.getMessage(), e);
//         }
//     }
// }
