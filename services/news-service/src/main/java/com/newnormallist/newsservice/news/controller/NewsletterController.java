...
import com.newnormallist.newsservice.news.dto.NewsletterSubscribeRequest;
import com.newnormallist.newsservice.news.service.NewsletterService;
...
public class NewsletterController {
    ...
    public ResponseEntity<?> subscribe(@Valid @RequestBody NewsletterSubscribeRequest request,
        ...
        try {
            ...
            NewsletterSubscribeRequest requestWithIp = NewsletterSubscribeRequest.builder()
                    .email(request.getEmail())
                    .sourceIp(ip)
                    .build();
            
            newsletterService.subscribe(requestWithIp);
