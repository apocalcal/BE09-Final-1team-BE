...
/**
 * 이 컨트롤러는 중복으로 인해 비활성화되었습니다.
 * 대신 com.newsservice.news.controller.NewsController를 사용하세요.
 * 
 * 통합된 뉴스 API는 다음 경로에서 제공됩니다:
 * - 뉴스 목록: GET /api/news
 * - 뉴스 상세: GET /api/news/{newsId}
 * - 카테고리별 뉴스: GET /api/news/category/{categoryName}
 * - 뉴스 검색: GET /api/news/search?query={keyword}
 * - 트렌딩 뉴스: GET /api/news/trending
 * - 최신 뉴스: GET /api/news/latest
 * - 카테고리 목록: GET /api/news/categories
 */
// @RestController
