...
import com.newsservice.news.dto.NewsDetailResponseDto;
import com.newsservice.news.dto.NewsListResponseDto;
...
public class NewsController {
    ...
    public ResponseEntity<?> getNews(
        ...
        try {
            ...
            Page<NewsListResponseDto> newsList = newsService.getNewsList(categoryEntity, keyword, pageable);
    ...
    // 특정(단건) 뉴스 상세 조회    
    @GetMapping("/{newsId}")
    public ResponseEntity<NewsDetailResponseDto> getNewsById(@PathVariable Long newsId) {
        NewsDetailResponseDto news = newsService.getNewsDetailById(newsId);
