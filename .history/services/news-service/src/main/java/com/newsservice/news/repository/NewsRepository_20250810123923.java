...
public interface NewsRepository extends JpaRepository<News, Long> {
    ...
    Page<News> findByCategory(@Param("category") com.newsservice.news.entity.Category category, Pageable pageable);
    ...
    // 카테고리별 뉴스 개수 조회
    @Query("SELECT COUNT(n) FROM News n WHERE n.category = :category")
    Long countByCategory(@Param("category") com.newsservice.news.entity.Category category);
